...
let currentHR = 56         // текущий пульс

let isBelowTarget = 0...targetLowerBound
let isInTarget = targetLowerBound...targetUpperBound
let isAboveTarget = currentHR...9999

if isInTarget.contains(currentHR) {
    print("Вы двигаетесь в правильном темпе!")
} else if isBelowTarget.contains(currentHR) {
    print("Вы всё делаете правильно, но попробуйте немного ускориться!")
} else if isAboveTarget.contains(currentHR) {
