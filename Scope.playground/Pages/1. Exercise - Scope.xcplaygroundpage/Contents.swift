/*:
 ...
 С помощью комментария или оператора print, объясните, почему код ниже выдаст ошибку времени компиляции, если вы уберёте комментарий в строке 11.
*/
for _ in 0..<10 {
    
    let foo = 55
    print("Значение foo = \(foo)")
    
}

//print("Значение foo = \(foo)")

print("Константа \"foo\" находится в области видимости лишь внутри цикла \"for\"!")
/*:
...
print("Первая функция \"print()\" выводит циклично значение \"x\", нахоящееся внутри цикла \"for\", вторая - значение глобальной переменной \"x\", получившей значение в ходе выполнения операций внутри цикла \"for\"!")
/*:
...
greeting(greeting: "Добрый день", name: "Аня")
greeting(greeting: nil, name: "Аня")
/*:
