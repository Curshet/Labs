...
if nameInCaps.lowercased() == name.lowercased() {
    print("\(nameInCaps.lowercased()) и \(name.lowercased()) равны.")
} else {
     print("\(nameInCaps.lowercased()) и \(name.lowercased()) не равны.")
}
/*:
 ...
 */
let textToSearchThrough = "Я помню чудное мгновенье: передо мной явилась ты, как мимолетное виденье, как гений чистой красоты."
 ...
 */
print("Количество букв в Вашем имени: \(name.count)")
